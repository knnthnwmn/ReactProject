    ...
    render() {
        return (
            <div className="container-fluid">
                <TableNav sortByTitle={this.sortSongsByTitle} sortByAlbum={this.sortSongsByAlbum} sortByArtist={this.sortSongsByArtist} sortByGenre={this.sortSongsByGenre}/>
                <SongTable songs={this.state.songs}  deleteASong={this.deleteSong} sortByTitle={this.sortSongsByTitle}/>
                <CreationForm createASong={this.createSong}/>
            </div>
        )
    }
